...
git init
git add .
git commit -m "Initial commit: Complete Book Store API"
```
...
4. Submit the GitHub repository link as required

## 🎯 Grading Checklist

- [x] Task 1: Get book list (2 pts)
- [x] Task 2: Get books by ISBN (2 pts)
- [x] Task 3: Get books by Author (2 pts)
- [x] Task 4: Get books by Title (2 pts)
- [x] Task 5: Get book reviews (2 pts)
- [x] Task 6: Register new user (3 pts)
- [x] Task 7: Login functionality (3 pts)
- [x] Task 8: Add/Modify review (2 pts)
- [x] Task 9: Delete review (2 pts)
- [x] Task 10: Async callback with Axios (2 pts)
- [x] Task 11: Promises with Axios (2 pts)
- [x] Task 12: Search by Author with async (2 pts)
- [x] Task 13: Search by Title with async (2 pts)
- [x] Task 14: GitHub submission (2 pts)

**Total: 30 Points**

## 📞 Support

For issues or questions, please refer to the code comments or test the endpoints using the provided examples.
